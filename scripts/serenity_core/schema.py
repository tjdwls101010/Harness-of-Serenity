...
SCHEMA_FILES = {
    ...
    "urn:serenity:schema:media-review-output:1": "media-review-output.schema.json",
    "urn:serenity:schema:method-claim-synthesis:1": "method-claim-synthesis.schema.json",
    "urn:serenity:schema:method-coding-output:1": "method-coding-output.schema.json",
